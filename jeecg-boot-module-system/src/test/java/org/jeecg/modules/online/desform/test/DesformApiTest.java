...
//        List<Processes> dingdans = processesMapper.selectList(wrapper);
//        for (Processes dingdan : dingdans) {
//            System.out.println(dingdan);
//        }
//    }

    @Test
    public void returnOnMachineCount() {
        ...
        QueryWrapper<Dingdan> queryWrapper4 = new QueryWrapper<>();
    }

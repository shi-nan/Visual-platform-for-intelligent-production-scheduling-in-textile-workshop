package org.jeecg.modules.dingdan.vo;
 ...
 */
@Data
@ApiModel(value="dingdanPage对象", description="订单表")
public class DingdanPage {
	...
	private List<Dingdanxiangqing> dingdanxiangqingList;
	@ExcelCollection(name="工人换班")
	@ApiModelProperty(value = "工人换班")
	private List<Staffchange> staffchangeList;
